(() => {
  ...
  // app/main/components/WelcomeGuard.js
  var WelcomeGuard = class {
    route = null;
    constructor(route) {
      var $this = this;
      $this.route = route;
  ...
  // app/main/components/AboutPage.js
  var AboutPage = class extends BaseComponent {
    _name = "AboutPage";
  ...
  // app/main/components/AccessPage.js
  var AccessPage = class extends BaseComponent {
    _name = "AccessPage";
    title = "Access";
  };
  var AccessPage_x = [
  ...
  // app/main/components/HowItWorksPage.js
  var HowItWorksPage = class extends BaseComponent {
    _name = "HowItWorksPage";
    title = "How It Works Page";
  };
  var HowItWorksPage_x = [
    function(_component) {
      return _component.title;
    },
    function(_component) {
  ...
  // app/main/components/NavigationPage.js
  var NavigationPage = class extends BaseComponent {
    _name = "NavigationPage";
    title = "Navigation";
  };
  var NavigationPage_x = [
    function(_component) {
      return _component.title;
    },
    function(_component) {
  ...
  // app/main/components/WelcomePage.js
  var WelcomePage = class extends BaseComponent {
    _name = "WelcomePage";
    title = "Welcome";
  };
  var WelcomePage_x = [
  ...
  function setUp() {
    ...
    factory("Platform", Platform3, () => new Platform3());
